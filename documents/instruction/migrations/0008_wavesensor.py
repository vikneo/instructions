        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_rkd",
                    models.CharField(
                        db_index=True, max_length=15, verbose_name="Desicn to RKD"
                    ),
                ),
                (
                    "description",
                    models.CharField(max_length=80, verbose_name="Name equipment"),
                ),
                ...
                (
                    "temp_warning",
                    models.CharField(max_length=3, verbose_name="Temperature warning"),
                ),
                (
                    "temp_error",
                    models.CharField(max_length=3, verbose_name="Temperature over"),
                ),
                (
                    "device_id",
                    models.ForeignKey(
